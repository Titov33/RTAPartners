...
export default function RTAREG({ navigation }) {
  ...
  const LINK_REGEX = /^((ftp|http|https):\/\/)?(www\.)?([A-Za-zА-Яа-я0-9]{1}[A-Za-zА-Яа-я0-9\-]*\.?)*\.{1}[A-Za-zА-Яа-я0-9-]{2,8}(\/([\w#!:.?+=&%@!\-\/])*)?/;
    ...
    <View style={Styles.container}>
        <View style={Styles.boxB}>
          <View style={[Styles.boxGL, {left: '10%'}]}>
            ...
            <GragientTextBlue style={[Styles.textB, {left: '-2%'}]} text='УПРАВЛЕНИЕ РЕКЛАМОЙ'></GragientTextBlue>
          </View>
        </View>
        ...
        <View style={[Styles.boxB, {top: '3.5%'}]}>
          <TouchableOpacity onPress={handleSubmit(onUploadPressed)} style={Styles.boxGL}>
      ...
      <ImageBackground source={require('../../../../images/Fire2.png')} style={Styles.imageBackground}/>
    </View>
  ); 
}
